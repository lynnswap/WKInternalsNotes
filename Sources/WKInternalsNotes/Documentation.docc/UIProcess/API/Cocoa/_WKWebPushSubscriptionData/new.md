...
## Discussion
ヘッダで `NS_UNAVAILABLE` 指定のため `new` は使用できない。`API::WebPushSubscriptionData` のラッパーとして内部生成される。

## References
- [`_WKWebPushSubscriptionData.h#L33`](https://github.com/WebKit/WebKit/blob/WebKit-7623.1.14.10.9/Source/WebKit/UIProcess/API/Cocoa/_WKWebPushSubscriptionData.h#L33)
