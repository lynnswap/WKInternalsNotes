...
WKNavigationDelegatePrivate の Objective-C private/testing API をカテゴリ別に整理した一覧。
...
- ``WKInternalsNotes/WKNavigationDelegatePrivate/_webView(_:didFailToInitializePlugInWithInfo:)``
